    ...
    return (
      <div className="min-h-screen bg-white p-8" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
        ...
        <div className="max-w-md mx-auto border border-slate-100 p-8 rounded-3xl shadow-xl mt-10">
          ...
          <input type="tel" placeholder={t.phonePlaceholder} className="w-full p-4 text-blue-500 bg-slate-50 rounded-xl mb-4 outline-none focus:ring-2 focus:ring-blue-900 border border-slate-100" />
